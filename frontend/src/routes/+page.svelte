	...
	<div class="mb-6">
		...
		{:else if templateList.length === 0}
			<div class="card text-center py-16">
				<svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-gray-300 mx-auto mb-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
				...
				<p class="text-gray-500 text-lg mb-2">Belum ada template.</p>
				<p class="text-gray-400 mb-6">Upload template DOCX untuk memulai.</p>
				<button
